  ...
  return (
    <>
      <nav
        ...
        className="bg-white/10 backdrop-blur-md text-gray-800 w-full py-1 rounded-xl max-w-7xl mx-auto"
      >
        <div className="flex justify-around items-center h-16 px-2">
          {navItems.map((item) => {
            ...
            return (
              <div
                key={item.name}
                className={`flex flex-col justify-center px-2 sm:px-3 items-center rounded-lg overflow-hidden ${
                  isActive
              ...
              >
                <button className="flex items-center justify-center p-0.5 rounded-full transition-colors text-gray-300 text-sm sm:text-base w-10 h-10">
                  {item.icon}
                </button>
                <span
