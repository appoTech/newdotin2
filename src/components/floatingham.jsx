...
const FloatingHamburgerMenu = () => {
  ...
  return (
    <div className="border-none flex z-9999 items-center justify-center">
      <div
        className='flex items-center justify-center hamburger-icon'
      ...
      <div
        ...
        style={{
          position: 'absolute',
          top: `${window.innerWidth <= 655 ? '-500%' : '-500%'}`,
          left: `${window.innerWidth <= 655 ? '-200%' : '-200%'}`,
